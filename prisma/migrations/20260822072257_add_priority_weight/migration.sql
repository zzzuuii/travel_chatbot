...
INSERT INTO "new_TouristSpot" ("entranceFee", "id", "latitude", "longitude", "name", "recommendedTime", "stayMinutes") SELECT "entranceFee", "id", "latitude", "longitude", "name", "recommendedTime", "stayMinutes" FROM "TouristSpot";
